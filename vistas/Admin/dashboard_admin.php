...
<body>
    ...
    <main class="contenido ml-64 pt-24 px-8 pb-10">
        <section class="mb-8">
            ...
            <p class="text-gray-500 mt-2">Panel general de empresas de ServiceCore.</p>
        </section>

        <!-- Tarjetas estadísticas -->
        <section class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8" id="tarjetas-stats">
            <div class="tarjeta animar">
                <p class="text-sm text-gray-500 uppercase mb-2">Total Empresas</p>
                <h2 class="text-4xl font-bold text-[#5750ad]" id="stat-empresas">--</h2>
            </div>
            <div class="tarjeta animar">
                <p class="text-sm text-gray-500 uppercase mb-2">Empresas Activas</p>
                <h2 class="text-4xl font-bold" id="stat-empresas-activas">--</h2>
            </div>
            <div class="tarjeta animar">
                <p class="text-sm text-gray-500 uppercase mb-2">Total Usuarios</p>
                <h2 class="text-4xl font-bold" id="stat-usuarios">--</h2>
            </div>
            <div class="tarjeta animar">
                <p class="text-sm text-gray-500 uppercase mb-2">Usuarios Activos</p>
                <h2 class="text-4xl font-bold" id="stat-usuarios-activos">--</h2>
            </div>
        </section>
        ...
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12 lg:col-span-8">
                <div class="tarjeta animar p-0 overflow-hidden">
                    <div class="flex justify-between items-center p-6 border-b">
                        <h2 class="text-2xl font-bold">Empresas Recientes</h2>
                        <a href="gestion_empresas.php" class="text-sm font-semibold text-[#5750ad] hover:underline">Ver todas</a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-gray-50 text-gray-500 uppercase text-sm">
                                <tr>
                                    <th class="p-5 text-left">Empresa</th>
                                    <th class="p-5 text-left">Correo de contacto</th>
                                    <th class="p-5 text-left">Usuarios</th>
            ...
            <div class="col-span-12 lg:col-span-4">
                <div class="tarjeta animar">
                    <h2 class="text-xl font-bold mb-5">Usuarios por Rol</h2>
                    <div id="usuarios-por-rol" class="space-y-4">
