...
<body>
    ...
    <main class="ml-64 pt-24 px-8 pb-10">
        <!-- CONTENIDO PRINCIPAL -->
        <section class="mb-8">
            <h2 class="text-4xl font-bold text-[#1e1858]">Crear Usuario</h2>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden animar">
                ...
                <form class="p-8 space-y-6" id="formUsuario">
                    ...
                    <div class="flex justify-end gap-4 pt-4 border-t">
                        ...
                        <button
                            type="reset"
                            class="px-6 py-3 border border-gray-300 rounded-xl text-gray-600 hover:bg-gray-100 transition">
                            Limpiar
                        </button>

                        <button
                            type="submit"
                            class="bg-[#5750ad] hover:bg-[#463d99] text-white px-8 py-3 rounded-xl font-semibold shadow-lg transition duration-300 hover:scale-105 flex items-center gap-2">
